...
<script src="ezslots_silver.js"></script>
...
<nav class="kayo-nav">
    ...
    <span class="slogan">
        <img src="images/slogan_silver.png" alt="">
    </span>
...
<div class="text-center btn-container">
    <span id="winwinwin1"><img src="images/btn_silver.png" alt=""></span><br>
		...
		var callbackFunction = function(result){
		    audio.pause();
					$.ajax({
						type: "POST",
						url: "getWinner.php",
						data: 'action=getWinner&type=silver&mobile='+winNum,
			...
			success: function(res) {
				...
				<div class="kayo-popUp" style="display: none">
				    ...
				    <div class="popup-content">
				        <img src="images/silver-popup.png" alt="">
