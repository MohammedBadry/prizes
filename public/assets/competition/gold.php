...
<script src="ezslots_gold.js"></script>
...
<div class="text-center btn-container">
    <span id="winwinwin1"><img src="images/btn_gold.png" alt=""></span><br>
...
$(function(){
		...
		var numbers = ['<img src="images/gold/0.png">','<img src="images/gold/1.png">','<img src="images/gold/2.png">','<img src="images/gold/3.png">','<img src="images/gold/4.png">','<img src="images/gold/5.png">','<img src="images/gold/6.png">','<img src="images/gold/7.png">','<img src="images/gold/8.png">','<img src="images/gold/9.png">'];
		...
		var callbackFunction = function(result){
		    audio.pause();
					$.ajax({
						type: "POST",
						url: "getWinner.php",
						data: 'action=getWinner&type=gold&mobile='+winNum,
        ...
        var ezslot1 = new EZSlots("ezslots1",{"reelCount":9,"startingSet":[0,0,0,0,0,0,0,0,0],"winningSet":realDigits,"symbols":numbers,"height":251,"width":186, "callback":callbackFunction,"time":time });
			...
			success: function(res) {
				...
				<div class="kayo-popUp" style="display: none">
				    ...
				    <div class="popup-content">
				        <img src="images/gold-popup.png" alt="">
